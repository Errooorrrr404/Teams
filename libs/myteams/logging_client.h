...
//!Handler called when a user connect to the server
//!(you or someone else)
/*!
    \param user_id a character pointer corresponding to
    the universally unique id assigned to the currently logged in user
...
/*!
    ...
    id assigned to the team hosting the thread.
    \param thread_id a character pointer corresponding to the universally unique
    id assigned to the thread hosting the reply.
    \param user_id a character pointer corresponding to the universally unique
...
/*!
    \param thread_id a character pointer corresponding to the universally unique
    id assigned to the thread in the team.
    \param user_id a character pointer corresponding to the universally unique
    id assigned to the user who created the thread.
...
/*!
    ...
    \param user_status an integer corresponding to the user status (0 = not
...
/*!
    \param team_id an unsigned integer corresponding to the WRONG team
    identifier
    \return On success, 1 is returned. On error, -1 is returned and errno
    is set appropriately
*/
