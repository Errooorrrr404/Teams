...
/*!
    \param team_id a character pointer corresponding to the
    universally unique identifier corresponding to the newly created team.
    \param team_name a character pointer corresponding to the name
    of the newly created team.
    \param user_id a character pointer corresponding to the name
    of the user who created the team.
...
/*!
    ...
    \param user_id a character pointer corresponding to the universally
    unique identifier corresponding to of the user joining the team.
...
/*!
    ...
    unique identifier corresponding to the corresponding team.
    \param user_id a character pointer corresponding to the universally
    unique identifier corresponding to the user leaving the team.
    \return On success, 1 is returned. On error, -1 is returned and
    errno is set appropriately
*/
